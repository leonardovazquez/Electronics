...
class demodulador_dsb(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "demodulador_dsb")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demodulador_dsb")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demodulador_dsb")
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1 = qtgui.freq_sink_f(
            1024, #size
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_update_time(0.10)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_y_axis(-140, 10)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_y_label('Relative Gain', 'dB')
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, 0.0, 0, "")
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.enable_autoscale(False)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.enable_grid(False)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_fft_average(1.0)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.enable_axis_labels(True)
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.enable_control_panel(False)


        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_plot_pos_half(not True)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_line_label(i, labels[i])
            self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_line_width(i, widths[i])
            self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_line_color(i, colors[i])
            self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_line_alpha(i, alphas[i])

        self._qtgui_freq_sink_x_0_1_0_0_0_0_1_win = sip.wrapinstance(self.qtgui_freq_sink_x_0_1_0_0_0_0_1.pyqwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_0_0_0_0_1_win)
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0 = qtgui.freq_sink_f(
            1024, #size
            firdes.WIN_BLACKMAN_hARRIS, #wintype
            0, #fc
            samp_rate, #bw
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0.enable_autoscale(False)
        self.qtgui_freq_sink_x_0_1_0_0_0_0.enable_grid(False)
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.band_pass_filter_0.set_block_alias("dsb")
        self.analog_sig_source_x_2_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 10000, 1, 0.5, 0)
        self.analog_sig_source_x_2_0.set_block_alias("local2")
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 1, 0, 0)
        self.analog_sig_source_x_2.set_block_alias("local")
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 50, 0, 0)
        self.analog_sig_source_x_1.set_block_alias("portadora")
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
        self.analog_sig_source_x_0.set_block_alias("modulante")
        ...
        self.connect((self.band_pass_filter_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0_0_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
        ...
        self.connect((self.dc_blocker_xx_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0_0_0, 0))
        self.connect((self.dc_blocker_xx_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(10, self.samp_rate, 6000, 12000, 4000, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(5, self.samp_rate, 2000, 500, firdes.WIN_BLACKMAN, 10))
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0_1.set_frequency_range(0, self.samp_rate)





def main(top_block_cls=demodulador_dsb, options=None):
