...
class bp_filter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Band pass filter", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "bp_filter")
        ...
        # Blocks
        ##################################################
        self._amplitude_range = Range(0.001, 1, 0.01, 0.001, 200)
...
def main(top_block_cls=bp_filter, options=None):
