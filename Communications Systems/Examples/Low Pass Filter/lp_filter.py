...
class lp_filter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Low pass filter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Low pass filter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lp_filter")
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(100, 10000, 100, 100, 200)
        ...
        self._amplitude_range = Range(1, 10, 0.5, 1, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 1500, 5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, frequency, amplitude, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 3000, 500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=lp_filter, options=None):
