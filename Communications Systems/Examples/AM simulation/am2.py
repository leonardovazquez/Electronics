...
class am2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Am mod-dem")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Am mod-dem")
        ...
        self.settings = Qt.QSettings("GNU Radio", "am2")
...
def main(top_block_cls=am2, options=None):
