...
class am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Am mod-dem", catch_exceptions=True)
        ...
        self._fol_win = RangeWidget(self._fol_range, self.set_fol, "oscilator rx", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(M)
        ...
        self.band_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_1_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -fol, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100000, 10, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 50000, 150000, 10000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15000, 200, window.WIN_HAMMING, 6.76))
