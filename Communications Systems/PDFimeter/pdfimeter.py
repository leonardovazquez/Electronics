...
class pdfimeter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pdfimeter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pdfimeter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pdfimeter")
        ...
        self.qtgui_histogram_sink_x_0_1.set_update_time(0.40)
        ...
        self.qtgui_histogram_sink_x_0.set_update_time(0.40)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100, 0.5, 0.5, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_histogram_sink_x_0_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_histogram_sink_x_0, 0))
    ...
    def set_bins(self, bins):
        self.bins = bins
        self.qtgui_histogram_sink_x_0.set_bins(self.bins)
        self.qtgui_histogram_sink_x_0_1.set_bins(self.bins)




def main(top_block_cls=pdfimeter, options=None):
