...
# Title: pluto_radiolink
# Author: Leonardo David Vazquez
# Generated: Tue Jan 25 12:46:47 2022
##################################################
...
class radiolinkpluto(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pluto_radiolink")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pluto_radiolink")
        ...
        self.settings = Qt.QSettings("GNU Radio", "radiolinkpluto")
...
def main(top_block_cls=radiolinkpluto, options=None):
