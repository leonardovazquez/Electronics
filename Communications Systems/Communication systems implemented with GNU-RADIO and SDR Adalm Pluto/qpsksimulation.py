...
# Generated: Tue Jan 25 12:49:23 2022
##################################################
...
class qpsksimulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsksimulation")
        ...
        self.qtgui_const_sink_x_0_0_0 = qtgui.const_sink_c(
        	1024, #size
        	"Constelacion antes de ser transmitida", #name
        	1 #number of inputs
        )
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(4, 0.0682, (RRC), 32, 0, 1, 1)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((1.2, ))
        ...
        self.connect((self.blks2_packet_encoder_0, 0), (self.blocks_char_to_float_0_0, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0_0, 0), (self.channels_channel_model_0, 0))
...
def main(top_block_cls=qpsksimulation, options=None):
